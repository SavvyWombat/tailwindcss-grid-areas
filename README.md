...
[![Build](https://img.shields.io/github/actions/workflow/status/SavvyWombat/tailwindcss-grid-areas/test.yml?branch=main)](https://github.com/SavvyWombat/tailwindcss-grid-areas/actions)
